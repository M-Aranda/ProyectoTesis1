package com.arandastock001.ocrsample;
...
//esta es la clase necesaria para que funcione el programa
public class TesseractOCR {
    ...
    public TesseractOCR(Context context, String language) {
        ...
        try {
            ...
            if (!f.exists()) {
                if (!f.mkdirs()) {
                    Toast.makeText(context, srcFile + " no se puede crear.", Toast.LENGTH_SHORT).show();
                }
            ...
            if (inFile != null && outFile != null) {
                ...
                Toast.makeText(context, srcFile + " no se puede leer.", Toast.LENGTH_SHORT).show();
            }
        }
    }
